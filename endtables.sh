...
## All Rights Reserved
## Creation Date: August 5, 2021
## Version: 0.0002
## Revision Date: August 6, 2021
##  
## Description: Table loader for endwall PF for OpenBSD
##
######################################################
## Dependencies:  nmap, pfctl,grep,cut,awk
################## INSTRUCTIONS ######################
## $ su
## # cp endtables.sh /root/sec
## # cd /root/sec
## # ./endtables.sh      # loads the blacklist table from /etc/blacklist.txt
## 
## Unload the table from cidr addresses
## # ./endtables.sh -u
##
## Manual add and delet from Tables 
