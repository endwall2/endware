...
###################################################
# TITLE: dnslookup.py
# DESCRIPTION: A dns lookup tool using python-pydns 
# AUTHOR: THE ENDWARE DEVELOPMENT TEAM
# COPYRIGHT: THE ENDWARE DEVELOPMENT TEAM, 2017
# CREATION DATE: JULY 1 2017
# VERSION: 0.01
# REVISION DATE: JULY 1 2017
###################################################
# DEPENDENCIES: python2-pydns, python2
###################################################
#####################################################################
# INSTRUCTIONS:  make a directory ~/bin and copy this file there, add this to the $PATH
#                then make the file executable and run it.
# $ mkdir ~/bin
# $ cp dnslookup.py ~/bin/dnslookup
# $ cd ~/bin
# $ chmod u+wrx dnslookup
