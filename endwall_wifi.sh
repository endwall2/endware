...
host_ip1=$(ip addr | grep -a "scope global dynamic $int_if1"|awk 'BEGIN  {FS="/"} {if (FNR==1) print $1}'| awk '{print $2}')
host_ip2=$(ip addr | grep -a "scope global dynamic $int_if2"|awk 'BEGIN  {FS="/"} {if (FNR==2) print $1}'| awk '{print $2}')
