...
#############################################
#TITLE: DNSREZ 
#DESCRIPTION: Simple DNS ip resloution of websites using your resolver in resolv.conf
#AUTHOR: ENDWALL
#COPYRIGHT: THE ENDWARE DEVELOPMENT TEAM, 2017 
#CREATION DATE: JULY 2 2017
#VERSION: 0.01
#REVISION DATE: JULY 2 2017
##############################################
# DEPENDENCIES: python-dnspython
############################################# 
#####################################################################
# Instructions:  make a directory ~/bin and copy this file there, add this to the $PATH
#                then make the file executable and run it.
# $ mkdir ~/bin
# $ cp dnsrez.py ~/bin/dnsrez
# $ cd ~/bin
# $ chmod u+wrx dnsrez
# $ export PATH=~/bin:"$PATH"
#
# Run ENDSTREAM
# $ dnsrez www.endchan.xyz
#
####################################################################
#############################################################################################################################################################################
#                                         ACKNOWLEDGMENTS
...
#################################################################################################################################################################################
#################### BEGINNGING OF PROGRAM ###############################
import sys 
import dns.resolver 

for arg in sys.argv[1:]: 
	## resolve the url
	for data in dns.resolver.query(arg, 'A') :
		print data.address
quit()
######################## END OF PROGRAM ##################################
