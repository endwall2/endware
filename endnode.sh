...
#
#
# CHANGE LOG:  - comment out gunzip
#              - wget + gunzip optimization
#              - Fixed headers + gunzip unpack html + replace curl with wget
...
torsocks -a "$torsocks_ip" -P "$torsocks_port" wget -T 30 --secure-protocol=TLSv1 --user-agent="$UA" --header="$HEAD1" --header="$HEAD2" --header="$HEAD3" --header="$HEAD4" -O "$check_tor.gz" https://check.torproject.org/
torsocks -a "$torsocks_ip" -P "$torsocks_port" wget -T 30 --secure-protocol=TLSv1 --user-agent="$UA" --header="$HEAD1" --header="$HEAD2" --header="$HEAD3" --header="$HEAD4" https://check.torproject.org/torcheck/img/tor-on.png https://check.torproject.org/torcheck/img/tor-on.ico
