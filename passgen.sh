...
#
######################################################################################################################################
# DEPENDENCIES: base64, head, /dev/urandom, /dev/random,   haveged
######################################################################################################################################
# INSTRUCTIONS:
#
...
echo "USAGE: $ passgen --rand               # using /dev/random instead of /dev/urandom use haveged with this switch"
echo " "
